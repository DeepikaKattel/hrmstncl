...
{{--                                            <td>--}}
{{--                                                <div class="text">--}}
{{--                                                    <i class="voyager-eye btn-warning"></i>--}}
{{--                                                    <i class="voyager-edit btn-primary"></i>--}}
{{--                                                    <i class="voyager-trash btn-danger"></i>--}}
{{--                                                </div>--}}
{{--                                            </td>--}}
{{--                                        </tr>--}}
{{--                                    </tbody>--}}
...
{{--            @endforeach--}}
        ...
        {{--                <div class="panel panel-bordered">--}}
                                ...
                                <div class="table-responsive employee col-lg-12 col-md-12 col-12">
                                    <table id="dataTable" class="table-hover table employee_table">
                                        <thead>
                                        <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        @elseif($row->type == 'image')
                                                                ...
                                                                <div class="details">
                                                                    ...
                                                                    <p><p class="department">{{$data->department->name}}</p>
                                                                </div>
