...
{{--                        <li role="presentation" class="{{ $loop->first ? 'active' : '' }}"><a href="{{ $menu_item->link() }}">{{ $menu_item->title }}</a></li>--}}
{{--                    @endforeach--}}
{{--                </ul>--}}
                {{--original tabs--}}
                <ul class="nav nav-tabs" role="tablist">
                    <li role="presentation" class="active"><a href="#Section1" aria-controls="home" role="tab" data-toggle="tab">Employee</a></li>
                    <li role="presentation"><a href="#Section2" aria-controls="profile" role="tab" data-toggle="tab">Attendance</a></li>
